    ...
    <div className="space-y-16">
      ...
      <section className="border-t rule pt-10 space-y-6">
        ...
        <div className="space-y-3">
          <a href="https://basescan.org/address/0xAf1b70F5BdDFfD64c5D7B971bA670e1ff65cB1bC" target="_blank" rel="noopener noreferrer" className="block p-4 border rule rounded-sm hover:bg-zinc-900/5 transition-colors">
            <h3 className="font-medium text-sm">Base (Mainnet)</h3>
            <code className="block mt-2 font-mono text-xs text-zinc-500 break-all">0xAf1b70F5BdDFfD64c5D7B971bA670e1ff65cB1bC</code>
